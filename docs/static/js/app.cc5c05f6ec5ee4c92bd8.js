...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__hello_news__ = __webpack_require__(572);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__hello_stones__ = __webpack_require__(575);
//
//
//
//
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_gallery_slideshow__ = __webpack_require__(584);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__firebase__ = __webpack_require__(283);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  firebase: {
    cards: {
      source: __WEBPACK_IMPORTED_MODULE_0__firebase__["a" /* db */].ref('cards'),
      cancelCallback: function cancelCallback(err) {
        console.error(err);
      }
    },
    max: {
      source: __WEBPACK_IMPORTED_MODULE_0__firebase__["a" /* db */].ref('max'),
      cancelCallback: function cancelCallback(err) {
        console.error(err);
      }
    },
    myNum: {
      source: __WEBPACK_IMPORTED_MODULE_0__firebase__["a" /* db */].ref('myNum'),
      cancelCallback: function cancelCallback(err) {
        console.error(err);
      }
    },
    unused: {
      source: __WEBPACK_IMPORTED_MODULE_0__firebase__["a" /* db */].ref('unused'),
      cancelCallback: function cancelCallback(err) {
        console.error(err);
      }
    }
  ...
  methods: {
    rand: function rand(max) {
      ...
      __WEBPACK_IMPORTED_MODULE_0__firebase__["a" /* db */].ref('cards/').update(list);
      __WEBPACK_IMPORTED_MODULE_0__firebase__["a" /* db */].ref('myNum/').update([0]);
      __WEBPACK_IMPORTED_MODULE_0__firebase__["a" /* db */].ref('unused/').update([true, true, true, true]);
      this.$forceUpdate();
    },
    change: function change() {
      if (this.max[0]['.value'] === 6) {
        __WEBPACK_IMPORTED_MODULE_0__firebase__["a" /* db */].ref('max/').update([9]);
      } else {
        __WEBPACK_IMPORTED_MODULE_0__firebase__["a" /* db */].ref('max/').update([6]);
      }
    },
    makeCard: function makeCard() {
      var idx = this.unused.map(function (o) {
        return o['.value'];
      }).indexOf(false);
      var v = this.myNum[0]['.value'];
      __WEBPACK_IMPORTED_MODULE_0__firebase__["a" /* db */].ref('myNum/').update([0]);
      var list = this.cards.map(function (o) {
        return o['.value'];
      });
      list[idx] = v;
      __WEBPACK_IMPORTED_MODULE_0__firebase__["a" /* db */].ref('cards/').update(list);
      ...
      list[idx] = true;
      __WEBPACK_IMPORTED_MODULE_0__firebase__["a" /* db */].ref('unused/').update(list);
    },
    use: function use(i, n, op) {
      if (!op) {
        __WEBPACK_IMPORTED_MODULE_0__firebase__["a" /* db */].ref('myNum/').update([n]);
      } else {
        if (op === '+') {
          __WEBPACK_IMPORTED_MODULE_0__firebase__["a" /* db */].ref('myNum/').update([this.myNum[0]['.value'] + n]);
        }
        if (op === '-') {
          __WEBPACK_IMPORTED_MODULE_0__firebase__["a" /* db */].ref('myNum/').update([this.myNum[0]['.value'] - n]);
        }
      ...
      var list = this.unused.map(function (o) {
        return o['.value'];
      });
      list[i] = false;
      __WEBPACK_IMPORTED_MODULE_0__firebase__["a" /* db */].ref('unused/').update(list);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_firebase__ = __webpack_require__(607);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_firebase___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_firebase__);


// Initialize Firebase
var app = Object(__WEBPACK_IMPORTED_MODULE_0_firebase__["initializeApp"])({
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_keys__ = __webpack_require__(621);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(269);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__App__ = __webpack_require__(563);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__router__ = __webpack_require__(568);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_semantic_ui_vue__ = __webpack_require__(643);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__babel_polyfill_noConflict__ = __webpack_require__(898);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_isomorphic_fetch__ = __webpack_require__(1071);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__firebase__ = __webpack_require__(283);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_vuefire__ = __webpack_require__(1073);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_vuefire___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_vuefire__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_es6_promise__ = __webpack_require__(1074);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_vue_autofocus_directive__ = __webpack_require__(1075);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_vue_autofocus_directive___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_vue_autofocus_directive__);
...
__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].directive('autofocus', __WEBPACK_IMPORTED_MODULE_9_vue_autofocus_directive___default.a);

__WEBPACK_IMPORTED_MODULE_8_es6_promise___default.a.polyfill();
__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].use(__WEBPACK_IMPORTED_MODULE_7_vuefire___default.a);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_App_vue__ = __webpack_require__(270);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_d722de96_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(566);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_d722de96_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__["a" /* default */],
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(269);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_router__ = __webpack_require__(569);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Hello__ = __webpack_require__(570);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Intro__ = __webpack_require__(579);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Maps__ = __webpack_require__(582);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_Table__ = __webpack_require__(587);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_StonesLog__ = __webpack_require__(590);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_Donate__ = __webpack_require__(593);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_Vedio__ = __webpack_require__(596);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_Faq__ = __webpack_require__(599);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_Card__ = __webpack_require__(602);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_Play12__ = __webpack_require__(605);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_Grid__ = __webpack_require__(619);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_Outer__ = __webpack_require__(629);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_Tools__ = __webpack_require__(632);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__components_Quiz__ = __webpack_require__(640);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Hello_vue__ = __webpack_require__(271);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_hello_news_vue__ = __webpack_require__(272);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_hello_stones_vue__ = __webpack_require__(273);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5bd58553_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_hello_stones_vue__ = __webpack_require__(577);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-5bd58553"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5bd58553_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_hello_stones_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Intro_vue__ = __webpack_require__(274);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Maps_vue__ = __webpack_require__(275);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Table_vue__ = __webpack_require__(276);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_StonesLog_vue__ = __webpack_require__(277);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Donate_vue__ = __webpack_require__(278);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Vedio_vue__ = __webpack_require__(279);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Faq_vue__ = __webpack_require__(280);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Card_vue__ = __webpack_require__(281);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Play12_vue__ = __webpack_require__(282);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5aeaabd0_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_Play12_vue__ = __webpack_require__(618);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-5aeaabd0"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5aeaabd0_hasScoped_true_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_Play12_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"hello"},[_c('div',{staticClass:"ui segment container"},[(_vm.max[0]['.value'] == 6)?_c('h2',[_vm._v("~~加減乘除湊 12~~")]):_c('a',{staticClass:"ui yellow button",on:{"click":function($event){_vm.change()}}},[_vm._v("改成湊 12")]),(_vm.max[0]['.value'] == 9)?_c('h2',[_vm._v("~~加減乘除湊 24~~")]):_c('a',{staticClass:"ui yellow button",on:{"click":function($event){_vm.change()}}},[_vm._v("改成湊 24")])]),_c('div',{staticClass:"ui segment container"},[_c('div',{staticClass:"ui horizontal list"},[_c('div',{staticClass:"item"},[_c('h2',{class:(_vm.max[0]['.value'] == 6 && _vm.myNum[0]['.value'] == 12) || (_vm.max[0]['.value'] == 9 && _vm.myNum[0]['.value'] == 24) ? 'good' : 'bad'},[(_vm.myNum[0]['.value'])?_c('a',{on:{"click":function($event){_vm.makeCard()}}},[_vm._v("目前數字："),_c('div',{staticClass:"ui yellow huge button"},[_vm._v(_vm._s(_vm.myNum[0]['.value']))])]):_c('span',[_vm._v("先按一個數字開始")])])])])]),_c('div',{staticClass:"ui container"},[_c('div',{staticClass:"ui four cards"},_vm._l((_vm.cards),function(c,$index){return _c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.unused[$index]['.value']),expression:"unused[$index]['.value']"}],staticClass:"ui card",class:$index % 2 == 0 ? 'orange' : 'yellow'},[(_vm.myNum[0]['.value'] != 0)?_c('div',{staticClass:"ui vertical buttons"},[_c('a',{staticClass:"ui huge orange button",on:{"click":function($event){_vm.use($index, c['.value'], '+')}}},[_vm._v("+"+_vm._s(c['.value']))]),_c('a',{staticClass:"ui huge yellow button",on:{"click":function($event){_vm.use($index, c['.value'], '-')}}},[_vm._v("-"+_vm._s(c['.value']))]),_c('a',{staticClass:"ui huge orange button",on:{"click":function($event){_vm.use($index, c['.value'], '*')}}},[_vm._v("×"+_vm._s(c['.value']))]),_c('a',{directives:[{name:"show",rawName:"v-show",value:(_vm.myNum[0]['.value'] != 0),expression:"myNum[0]['.value'] != 0"}],staticClass:"ui huge yellow button",on:{"click":function($event){_vm.use($index, c['.value'], '/')}}},[_vm._v("÷"+_vm._s(c['.value']))])]):_vm._e(),(_vm.myNum[0]['.value'] == 0)?_c('a',{on:{"click":function($event){_vm.use($index, c['.value'])}}},[_c('h1',[_vm._v(_vm._s(c['.value']))])]):_vm._e()])}))]),_c('div',{staticClass:"ui segment container"},[_c('a',{staticClass:"ui yellow button",on:{"click":function($event){_vm.rand(_vm.max[0]['.value'])}}},[_c('h2',[_vm._v("再來!")])])]),_vm._m(0),_c('br'),_c('br')])}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Grid_vue__ = __webpack_require__(284);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Outer_vue__ = __webpack_require__(291);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Tools_vue__ = __webpack_require__(292);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Quiz_vue__ = __webpack_require__(293);
/* unused harmony namespace reexport */
...
//# sourceMappingURL=app.cc5c05f6ec5ee4c92bd8.js.map