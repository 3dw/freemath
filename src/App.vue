  ...
  data () {
    return {
      ...
      units: [
        ...
        {n: '乘法E~F', d:'乘法直式的學習', g: 2, G: 5, url: 'https://docs.google.com/document/d/1zUE7ROOqhaIALC3k0rimZPv8Fo1lf8-gYORG1Wr6eXg/edit?usp=sharing', edit: true, p: 90, left: 1,  wiki: '乘法'},
        ...
        {n: '數線', d:'學習用數線表示數字', g: 3, G: 7, wiki: '數線', url: 'https://docs.google.com/document/d/1zZIt-DV6TRzENoDAFX3B-_EPISEGL91KCXd7JIofOx0/edit?usp=sharing', p: 100, left: 2},
        ...
        {n: '體積與容積', d:'學習體積與容積的相關知識', g: 4, G: 6, wiki: '體積', url: 'https://docs.google.com/document/d/1YDhE2j3YfOvlIbQxry-EKBz7LxeQiVt7mM-eCcwL-nE/edit?usp=sharing', left: 0},
        ...
        {n: '分數到小數', d:'從分數延伸學習，建立小數的概念', g: 5, G: 6, wiki: '小數', url: 'https://docs.google.com/document/d/1xr9bhw0qcsio0R3FU9gUOIjW8Ir2mQpAh0fjJh4cnu0/edit?usp=sharing', left: 2},

        {n: '物理量與單位換算', d:'從單位換算學習比例', wiki: '單位換算',
          g: 5, G: 6, url: 'https://docs.google.com/document/d/12R1oi-Jia84mYixQBys83TIiM_eMCJfNzQLtXgrLLis/edit', edit: true, p: 30, left: 3},
        ...
        {n: '因數與倍數', d:'瞭解因倍數和公因數、公倍數，質因數分解等', g: 6, G: 7, wiki: '因數', url: 'https://docs.google.com/document/d/1RcZy2CN6HSP-wsXb1g61A-Sq0QWjwY3TCJVRWTq3fTQ/edit?usp=sharing', left: 0},
        ...
        {n: '小學數學觀念精華', d:'一次複習所有小學的重要單元', g: 6, G: 9, url: 'https://docs.google.com/document/d/1xUDSZPP1lmReEpAOhCXKUEln105MrVjFo05E4FcpMx0/edit?usp=sharing', p: 100, left: 3},

        {n: '正負分數', d:'透過減法和除法，進入負分數的領域', g: 7, G: 7, wiki: '有理數', url: 'https://docs.google.com/document/d/1tD4_6l1spXg7p6M7bRBb8wNwIJcCSfQIPh_LNu-rfjE/edit?usp=sharing', left: 0},
        ...
        {n: '指數與科學記號', d:'學習指數、指數律與科學記號', g: 7, G: 8, wiki: '科學記號', url: 'https://docs.google.com/document/d/1j5tdf0TirLjFHTLIcWy4lgSe1oIFh7NshM6GDHCOduE/edit?usp=sharing', left: 1.5},

        {n: '二元一次方程式', d:'學習二元一次方程式的列式和解題', g: 7, G: 8, wiki: '一次方程#二元一次方程组', url: 'https://docs.google.com/document/d/1v80VUYFsiW5V_jEOwPdOAHya5V75XQRzvRfbwnwpPLI/edit?usp=sharing', left: 2},
        ...
        {n: '函數圖形', d:'學習直角座標上的函數圖形如何表示', g: 7, G: 8, wiki: '函數', url: 'https://docs.google.com/document/d/163OdWL9EwW4LxRTHIIzpVCnohcg4f3vpebXe2nfFT8E/edit?usp=sharing', left: 3},

        {n: '一元二次方程式', d:'學習一元二次方程式的列式和解題', g: 8, G: 9, wiki: '一元二次方程式', url: 'https://docs.google.com/document/d/16fwpdw89fssKH4rpN5Ihc93zU-YCubBhzDUXs30wKcI/edit?usp=sharing', left: 0},
        ...
        {n: '勾股定理', d:'學習勾股定理及其應用和證明', g: 8, G: 9, wiki: '勾股定理', url: 'https://docs.google.com/document/d/1rPovRRDJ_JBPpQ-MVasmb3s1tXdDcZKGCKLc0TW5fCI/edit?usp=sharing', left: 1},

        {n: '根式運算', d:'學習根式運算的各種技巧', g: 8, G: 9, wiki: '平方根', url: 'https://docs.google.com/document/d/10oB3rrEhC0yvLlilr8vjAu-Q9LuS6IzRLea4flzYNAo/edit?usp=sharing', left: 1.5},
        ...
        {n: '全等形', d:'學習利用全等形作幾何證明', g: 8, G: 9, wiki: '全等', url: 'https://docs.google.com/document/d/1oPIdcpSMcYED93EK8pTIwLbqg6tRZz0RyQXKp5HtkI8/edit?usp=sharing', left: 2.5},
        {n: '尺規作圖', d:'學習基本的尺規作圖技巧', g: 8, G: 9, wiki: '尺規作圖', url: 'https://docs.google.com/document/d/1n3BiAVTJXojaYzwV7RjosJinobehwgJQ5IvZNeCAjnY/edit?usp=sharing', left: 3},
        ...
        {n: '多項式', d:'學習基本的多項式運算', g: 9, G: 10, wiki: '多項式', url: 'https://docs.google.com/document/d/1wFxpNIhsG2GyA-WLfrtlbqUxrnCKdVnDZ4HjsSw2vVI/edit?usp=sharing', left: 1},
        {n: '機率與統計', d:'學習基本的機率與統計概念', g: 9, G: 11, wiki: '機率', url: 'https://docs.google.com/document/d/1L2gtHUKAe-pANjFS6XE1fAHVYvjgs20MLOFY3ElYYfM/edit?usp=sharing', left: 1},
        {n: '二次函數', d:'學習二次函數的作圖和計算', g: 9, G: 10, wiki: '二次函數', url: 'https://docs.google.com/document/d/14WG9W2YWzH8t-8BjDBOEcOoJCXErI1qx1tz9geLKY3Q/edit?usp=sharing', left: 1.5},
        ...
        {n: '三角形的心', d:'認識三角形的三顆心和相關的幾何證明', g: 9, G: 9, wiki: '三角形的心', url: 'https://docs.google.com/document/d/1G3oG30oKd--F8t-IH2KKhEthAawf2e0C6SEGDbs2yP8/edit?usp=sharing', left: 2.5},

        {n: '相似三角形', d:'學習用相似三角形作幾何證明', g: 9, G: 10, wiki: '相似三角形', url: 'https://docs.google.com/document/d/1bLdm7nF8N4-JeyP0ODdVNUK1oos1OYiYCPnVkgoBhso/edit?usp=sharing', left: 3},

        {n: '球體的體積', d:'學習球體體積公式的證明過程', g: 9, G: 10, wiki: '球體', url: 'https://docs.google.com/document/d/1nSZuUmEuVyqwBQJIv61zQ_vxLm15GfmcmLSaBVHCtDc/edit#', edit: true, p: 50, left: 4},
        ...
        {n: '極座標', d:'學習用極座標表示點和曲線', g: 10, G: 11, wiki: '極座標', url: 'https://docs.google.com/document/d/1nSckL7Ge66iC9XHd7tp0VMmLiDdtT78SFKZmTiSYlEw/edit?usp=sharing', edit: true, p: 80, left: 2},

        {n: '國中數學觀念精華', d:'一次複習所有國中的重要單元', g: 10, G: 11, wiki: '', url: 'https://docs.google.com/document/d/1lw-1BIsl9uLPfphIQ_Ns4xbpLhE7D_KEn9B7Tomjrsw/edit?usp=sharing', p: 80, left: 3},

        {n: '三角函數', d:'認識三角函數及其應用', g: 11, G: 12, wiki: '三角函數', url: 'https://docs.google.com/document/d/1W1ZhNi-rbMmB8im9RTJRPfjtw1a6EJSgo3An4d11Dl0/edit?usp=sharing', edit: true, p: 50, left: 3},

        {n: '實無限與微分', d:'認識實無限、微分及其應用', wiki: '無窮小量', g: 12, G: 12, url: 'https://docs.google.com/document/d/1W-lzb6HtaYWLU1S2ypVwmxP6jckXSe7n4oRxJiL52gw/edit?usp=sharing', edit: true, p: 80, left: 1},
        {n: '實無限與積分', d:'認識實無限、積分及其應用', wiki: '非標準分析', g: 12, G: 12, url: 'https://docs.google.com/document/d/1rWVyaTU31Wy4NFvwCtDpTlmEmNCRwqL4YOTpLHhfyi0/edit?usp=sharing', edit: true, p: 50, left: 2}
      ]
    }
  },
  firebase: {
