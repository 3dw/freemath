      ...
      .one.column.row
        .column
          .ui.segment.container
            ...
            p
              | {{ sify('另一方面，由於追求適性教育，台灣的在家自學人數愈來愈多，台北市一年約有三百人，且還在不停成長。自學生迫切需要教學資源，不只是教材，還有知識的脈絡，讓他們能用自己的步調學習，而非暗中瞎闖。') }}
            p
      ...
      .two.column.doubling.row
        .column
          .ui.segment
            ...
            p
              | {{ sify('剛好那時候父親幫康軒編了數學好小子這一套國小數學教材，以填充格讓學生能夠跟著解題思路走，就向Bestian提議合編一套國中數學教材，') }}
